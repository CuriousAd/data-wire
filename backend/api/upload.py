...
MAX_FILE_SIZE = 3 * 1024 * 1024  # 3MB — Render free-tier RAM cap
...
async def upload_csv(
    ...
    if file_size > MAX_FILE_SIZE:
        raise HTTPException(status_code=413, detail={"message": "The uploaded CSV exceeds the 3 MB limit. Please trim or sample your dataset before uploading.", "code": "FILE_TOO_LARGE"})
